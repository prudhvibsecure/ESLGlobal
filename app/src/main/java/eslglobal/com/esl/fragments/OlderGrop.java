...
import eslglobal.com.esl.adapter.OlderAdapter;
...
public class OlderGrop extends ParentFragment implements IItemHandler {
...
//			link = link.replace("(COMID)", item.getAttribute("composeid"));
	...
	public void onFragmentChildClick(View view) {
		...
		bsecure.showComposeViewMessagePageView(item);
