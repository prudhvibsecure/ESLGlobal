...
import eslglobal.com.esl.controls.ColorGenerator;
import eslglobal.com.esl.controls.TextDrawable;
import eslglobal.com.esl.imageloader.ImageLoader;

public class MailsListingAdapter extends RecyclerView.Adapter<MailsListingAdapter.ContactViewHolder> {
	...
	private boolean isCheckBoxEnable = false, isCheckitem = false;

	public MailsListingAdapter(Context context, String domainName) {
	...
	public void onBindViewHolder(ContactViewHolder contactViewHolder, int i) {
		...
		if (item.getAttribute("attachment").equalsIgnoreCase("yes")
				|| item.getAttribute("draftattachment").equalsIgnoreCase("yes"))
	...
	public void showCheckItem(boolean show) {
		isCheckitem = show;
	}
