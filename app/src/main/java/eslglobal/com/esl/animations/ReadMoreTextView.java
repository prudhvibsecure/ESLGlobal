...
package eslglobal.com.esl.animations;
...
public class ReadMoreTextView extends TextView {
	...
	private CharSequence updateExpandedText() {
		SpannableStringBuilder s = new SpannableStringBuilder(text, 0, trimLength + 1).append(ELLIPSIZE)
